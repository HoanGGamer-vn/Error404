      ...
      <div class="install-prompt" role="dialog" aria-labelledby="install-title" aria-describedby="install-description">
        ...
        <div class="install-content">
          <div class="install-icon">
                    <img :src="base + 'icons/icon.svg'" alt="Error404 App Icon" />
                  </div>
...
// Use Vite's BASE_URL or fallback to "/"
...
const registerServiceWorker = async () => {
  ...
  if (import.meta.env.DEV) {
    ...
    try {
      // Use Vite base so SW works under repo subpath on GitHub Pages
      ...
      // Handle skipWaiting message from SW
