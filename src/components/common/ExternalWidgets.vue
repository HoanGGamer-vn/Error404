          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-for="message in messages" :key="message.id" :class="['message', message.type]">
              <div class="message-avatar" v-if="message.type === 'bot'">
                <img :src="asset('/icons/bot-avatar.svg')" alt="Support" />
              </div>
          ...
          <div class="social-section facebook-section">
            ...
            <div class="facebook-widgets">
              ...
              <div class="social-debug" style="margin-top: 16px; padding: 12px; background: rgba(196, 172, 125, 0.1); border-radius: 8px; font-size: 12px; color: #9ca3af;">
                ...
                <div>Twitter SDK: {{ twttrLoaded ? '✅ Loaded' : '⏳ Loading...' }}</div>
                <div>YouTube SDK: {{ gapiLoaded ? '✅ Loaded' : '⏳ Loading...' }}</div>
...
const twttrLoaded = computed(() => typeof (globalThis as any).twttr !== 'undefined')
const gapiLoaded = computed(() => typeof (globalThis as any).gapi !== 'undefined')
