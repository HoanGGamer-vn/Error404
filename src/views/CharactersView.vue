...
const factions = ref<Faction[]>([
  {
    name: 'UNKNOWN',
  icon: asset('/images/icon-01.webp'),
  symbol: asset('/images/symbol-huanglong.webp'),
  ...
  {
    name: 'HUANG LONG',
      icon: asset('/images/icon-02.webp'),
    symbol: asset('/images/symbol-federation.webp'),
    description: "HUANG LONG",
    characters: [
      {
        name: 'Yinlin',
        title: 'Name\'s Yinlin. As for what I do... Shhh, we don\'t talk about that in public.',
  image: asset('/images/yinlin-9f681990.webp'),
        element: 'Spectro',
        rarity: 5,
        weapon: 'Sword',
description: 'Previously known as an outstanding Jinzhou Patroller, Yinlin is steady and reliable, yet harbors hidden depths of secrets. She excels at exploiting resources at her disposal to uncover lurking crimes. Beneath her aloof and flamboyant exterior, Yinlin possesses a heart of gold, reserved only for those she deems trustworthy.'
  ...
  image: asset('/images/zhezhi-6698177e.webp'),
        element: 'Fusion',
        rarity: 5,
        weapon: 'Rectifier',
  ...
  image: asset('/images/changli-3da788f2.webp'),
        element: 'Fusion',
        rarity: 5,
        weapon: 'Rectifier',
  ...
  {
    name: 'BLACK SHORES',
  icon: asset('/images/icon-03.webp'),
  symbol: asset('/images/symbol-blackshores.webp'),
  ...
  image: asset('/images/cantarella-f997fb74.webp'),
        element: 'Spectro',
        rarity: 5,
        weapon: 'Rectifier',
  ...
  icon: asset('/images/icon-04.webp'),
  symbol: asset('/images/symbol-rangers.webp'),
    description: 'Elite scouts and protectors of the wilderness',
    characters: [
      {
        name: 'Aalto',
        title: 'The Mist Walker',
  image: asset('/images/character4-1.webp'),
        element: 'Aero',
        rarity: 4,
        weapon: 'Pistols',
  ...
  {
    name: 'Ghost Hounds',
  icon: asset('/images/icon-05.webp'),
  symbol: asset('/images/symbol-ghosts.webp'),
    description: 'Mercenaries and outcasts seeking redemption',
    characters: [
      {
        name: 'Danjin',
        title: 'The Blood Blade',
  image: asset('/images/character5-1.webp'),
        element: 'Havoc',
        rarity: 4,
        weapon: 'Sword',
  ...
  {
    name: 'Sentinel Corps',
  icon: asset('/images/icon-06.webp'),
  symbol: asset('/images/symbol-sentinel.webp'),
    description: 'Elite guardians of ancient secrets',
    characters: [
      {
        name: 'Jiyan',
        title: 'The Dragon General',
  image: asset('/images/character6-1.webp'),
        element: 'Aero',
        rarity: 5,
        weapon: 'Broadblade',
  ...
  {
    name: 'Crystal Order',
  icon: asset('/images/icon-07.webp'),
  symbol: asset('/images/symbol-crystal.webp'),
    description: 'Masters of crystalline energy and ancient knowledge',
    characters: [
      {
        name: 'Verina',
        title: 'The Crystal Sage',
  image: asset('/images/character7-1.webp'),
        element: 'Spectro',
        rarity: 5,
        weapon: 'Rectifier',
